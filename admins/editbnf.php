                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <?php foreach ($benefit as $bnf): ?>
                                <i class="<?= $bnf["icon"]; ?>" style="font-size:30px;"></i>
                                <div class="row">
                                ...
                                <input type="text" name="header" id="" class="form-control" required
                                    value="<?= $bnf["header"]; ?>"><br>
                                Teks
                                <input type="text" name="teks" id="" class="form-control" required
                                    value="<?= $bnf["teks"]; ?>"><br>
                                <input type="hidden" name="id" id="" value="<?= $bnf["id"]; ?>">
                            <?php endforeach; ?>
                            <button type="submit" name="bnf" class="btn btn-primary">Submit</button>
                        </div>
                    </form>
