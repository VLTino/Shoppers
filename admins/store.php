...
$location = query("SELECT * FROM `storelocation` WHERE `id` = 1;");
    ?>
<!DOCTYPE html>
<html lang="en">
...
<script>
  ...
  if (successParam && successParam === "true") {
    ...
    <?php foreach ($location as $lc): ?>
                        ...
                        <?php endforeach; ?>
                        <a href="storelocation.php" class="btn btn-primary" style="position: absolute; bottom: 10px; right: 10px;">Edit</a>
                    </div>
