                ...
                <div class="container-fluid">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            Color Picker <br>
                            <input id="colorpicker" name="color" type="text" /><br>
                            <script>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php if (empty($color)): ?>
                                <tr>
                                <tr>
                                    <td colspan="7" style="color:red;">Belum ada color</td>
                                </tr>
                            <?php else: ?>
                                <?php $i = 1; ?>
                                <?php foreach ($color as $clr): ?>
                                    ...
                                    <td style="background-color:<?= $clr["codeclr"]; ?>;font-weight:bold;color:black;">
                                        <?= $clr["color"]; ?>
                                    </td>
                                    <td>
                                        <a href="editclr.php?id=<?= $clr["id"]; ?>" class="btn-circle btn-success btn-sm"><i
                                                class="fas fa-pen"></i></a>
                                        <a onclick="return confirm('Apakah kamu yakin ingin mengapus ini?')"
                                            href="deleteclr.php?id=<?= $clr["id"]; ?>" class="btn-circle btn-danger btn-sm"><i
