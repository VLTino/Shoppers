...
<body id="page-top">
 ...
 <li class="nav-item">
  ...
  <strong>Yeay</strong> Contact Info Berhasil Diedit!
    ...
    showAlert();
                    ...
                    <form action="" method="post">
                        <div class="form-group">
                            ...
                            ?>
                        Alamat Lengkap Toko
                        <input type="text" name="alamattoko" id="" class="form-control" value="<?= $alamat; ?>">
                        Phone
                        <input type="text" name="phone" id="" class="form-control" value="<?= $phone; ?>">
                        Email
                        <input type="email" name="email" id="" class="form-control" value="<?= $email; ?>"><br>
                        <button type="submit" class="btn btn-primary" name="ctc">Edit</button>
                        <?php endforeach; ?>
                        </div>
                    </form>
