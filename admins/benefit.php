        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($benefit as $bnf): ?>
                                <tr>
                                    ...
                                    <td><i class="<?= $bnf["icon"]; ?>" style="font-size:50px;"></i></td>
                                    <td>
                                        <?= $bnf["header"]; ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="editbnf.php?id=<?php echo $bnf["id"]; ?>"
                                            class="btn-circle btn-success btn-sm"><i class="fas fa-pen"></i></a>
                                        <a onclick="return confirm('Apakah kamu yakin ingin mengapus ini?')"
                                            href="deletebnf.php?id=<?php echo $bnf["id"]; ?>"
                                            class="btn-circle btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    ...
                    <a href="plusbenefit.php" class="btn btn-primary">Tambah</a>
